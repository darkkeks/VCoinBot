...
def get_url(token):
    url = f"https://api.vk.com/method/execute.resolveScreenName?v=5.97&" \
        f"https=1&" \
        f"screen_name=app6915965&" \
        f"url=https%3A%2F%2Fvk.com%2Fapp6915965_-137565779&" \
        f"lang=ru&" \
        f"owner_id=-137565779&" \
        f"func_v=8&" \
